...
import com.treehouse.model.DTO.PaymentDto;
import com.treehouse.model.Payment;
...
public class OrderController {
	...
	@PostMapping("/Bucket/orders/{token}")
	public ResponseEntity<Orders> buyProduct(@PathVariable ("token") String token, @RequestBody PaymentDto payment) throws CustomerException {

		return new ResponseEntity<Orders>(customerService.placeOrders(token,payment), HttpStatus.CREATED);
